...
class Product(models.Model):
    ...
    category =models.ForeignKey(Sub_Category, on_delete=models.CASCADE, default=1,blank=True,null=True)
    brand = models.ForeignKey(Major_Categories, on_delete=models.CASCADE, default=1)
    description = models.TextField(max_length=1000,blank=True,null=True)
    image =models.ImageField(upload_to='Uploads/products/',default='Categories/arcrid.jpg')
    image2 =models.ImageField(upload_to='Uploads/products/',default='Categories/arcrid.jpg')
    image3 =models.ImageField(upload_to='Uploads/products/',default='Categories/arcrid.jpg')
    image4 =models.ImageField(upload_to='Uploads/products/',default='Categories/arcrid.jpg')
