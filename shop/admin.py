...
class AdminProduct(admin.ModelAdmin):
    list_display = ['name', 'price','stock','selling_price','category','brand','image','dates','shop_name','shop',]
    search_fields = ('name',)
    list_filter = ('brand', 'dates','category')
    ordering=('-dates',)
    list_editable = ('selling_price','shop_name','shop')
    change_list_template = "../templates/change_list.html"
    def changelist_view(self, request, extra_context=None):
        extra_context = extra_context or {}
        extra_context['Products'] = 'Products'
...
admin.site.register(Major_Categories,AdminBrand )
